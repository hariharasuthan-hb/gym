...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('workout_videos', function (Blueprint $table) {
            ...
            $table->text('trainer_feedback')->nullable(); // Feedback from trainer
            $table->foreignId('reviewed_by')->nullable()->constrained('users')->onDelete('set null'); // Trainer who reviewed
