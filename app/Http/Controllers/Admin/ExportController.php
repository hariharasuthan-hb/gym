...
class ExportController extends Controller
{
    ...
    public function export(Request $request, string $type): JsonResponse
    {
        ...
        // Get trainer context for filtering
        $trainerContext = TrainerFilterService::getTrainerContext($userId);
        ...
        $jobClass::dispatch($type, $filters, $userId, $format, $trainerContext);
