...
- **Activity Tracking**: Daily check-in/check-out with QR code and RFID support
- **Workout Plans**: Trainers can create and assign workout plans to members
- **Diet Plans**: Nutrition and meal plan management
...
- `workout_plans` - Trainer-assigned workout plans
...
- **Trainer**: Can manage workout/diet plans, track member activities
