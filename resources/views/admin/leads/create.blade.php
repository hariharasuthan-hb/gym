...
<div class="container mx-auto px-4 py-8 max-w-5xl">
    ...
    <div class="flex justify-between items-center mb-6">
        <div>
            <h1 class="text-lg font-semibold text-gray-900">Create New Lead</h1>
        </div>
    ...
    <form action="{{ route('admin.leads.store') }}" method="POST" 
        ...
        <div class="p-8">
            @include('admin.leads._form', ['lead' => null, 'users' => $users, 'statusOptions' => $statusOptions, 'sourceOptions' => $sourceOptions, 'isEdit' => false])
        </div>
