...
<div class="space-y-6">
    ...
    <div class="admin-card">
        <form method="GET" id="invoices-filter-form" class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-4">
            <div>
                ...
                <input type="text"
                       ...
                       placeholder="Invoice #, transaction ID, user">
            </div>
            <div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            function initInvoiceFilters() {
                if (typeof window.$ === 'undefined') {
                    return setTimeout(initInvoiceFilters, 100);
                }

                const $form = window.$('#invoices-filter-form');
