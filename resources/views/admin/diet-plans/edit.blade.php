...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-lg font-semibold text-gray-900">Edit Diet Plan</h1>
    ...
    <div class="admin-card">
        <form action="{{ route('admin.diet-plans.update', $dietPlan->id) }}" method="POST">
            @csrf
            @method('PUT')
            @include('admin.diet-plans._form', ['dietPlan' => $dietPlan, 'isEdit' => true])
