...
<div class="space-y-6">
    <div class="flex justify-between items-center">
        <h1 class="text-lg font-semibold text-gray-900">Edit Workout Plan</h1>
    ...
    <div class="admin-card">
        <form action="{{ route('admin.workout-plans.update', $workoutPlan->id) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            @include('admin.workout-plans._form', ['workoutPlan' => $workoutPlan, 'isEdit' => true])
